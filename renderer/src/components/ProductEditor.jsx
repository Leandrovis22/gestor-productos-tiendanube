...
export const ProductEditor = ({
  ...
  // Sección del formulario general
  const GeneralForm = () => (
    <div>
      <div className="mb-1">
  ...
  // Sección del formulario de variantes
  const VariantsForm = () => (
    <div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2 ml-4">
                        ...
                        <input
                          type="text"
                          value={variant.price}
                          onChange={(e) => onUpdateVariantPrice(variant.id, e.target.value)}
                        ...
                        <input
                          type="text"
                          value={variant.stock}
                          onChange={(e) => onUpdateVariantStock(variant.id, e.target.value)}
